...
const ALLOW = {
  ...
  setIntervalFrontend: [
    ...
    // 10s transient send countdown animation timer in dispatch progress card, self-clearing on completion
    'frontend/src/components/dispatchwhatsappprogresscard.tsx',
