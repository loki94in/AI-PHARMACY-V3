...
describe('Email Purchase Distributor Integrity Tests', () => {
  ...
  test('11. Confirm getInvoiceWhatsAppRecipients resolves based on user setting (both, store, owner, none)', async () => {
    ...
    await db.run('INSERT OR REPLACE INTO app_settings (key, value) VALUES ("shop_phone", "9900000001")');
    await db.run('INSERT OR REPLACE INTO app_settings (key, value) VALUES ("owner_whatsapp_number", "9900000002")');
    ...
    expect(bothRecipients).toContain('9900000001');
    expect(bothRecipients).toContain('9900000002');
    ...
    expect(storeRecipients).toEqual(['9900000001']);
    ...
    expect(ownerRecipients).toEqual(['9900000002']);
