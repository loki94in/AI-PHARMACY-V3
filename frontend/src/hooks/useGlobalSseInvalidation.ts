...
const SSE_QUERY_MAP: Record<string, string[][]> = {
  ...
  purchase_sync: [['purchases'], ['purchase-history-list'], ['investigation-list']],
  ...
  distributors_updated: [['distributors'], ['distributor-list'], ['master-distributors']],
...
const SSE_CUSTOM_EVENTS: Record<string, string[]> = {
  ...
  sales_sync: ['sse-sales-sync', 'stock-write-completed'],
  distributors_updated: ['sse-distributors-updated', 'distributors-updated'],
  stores_updated: ['sse-stores-updated'],
  settings_updated: ['sse-settings-updated'],
  audit_updated: ['sse-audit-updated'],
